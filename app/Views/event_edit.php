                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <select class="form-control" name="enabled" id="enabled" data-sel-val="<?= $event['category_id'] ?>">
                                                    ...
                                                    <div class="form-group mt-2">
                                                        ...
                                                        <select class="form-control" name="category" id="category" data-sel-val="<?= $event['category_id'] ?>">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="aa-kpi-row d-flex mb-2" data-kpi-id="<?= $val['id'] ?>">
                                                        <input type="text" class="form-control" name="option_name[]" value="<?= $val['meta_name']?>" style="margin-right: .3rem;" disabled>
                                                        <input type="text" class="form-control" name="option_val[]" value="<?= $val['kpi_value']?>" style="margin-left: .3rem;" disabled>
                                                    ...
                                                    <div class="aa-kpi-wrapper d-flex" id="kpiWrapper">
                                                        <select type="text" class="form-control" name="kpi_dump" id="kpi_dump" style="margin-right: .3rem;">
