                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" class="form-control" name="event_name_ar" id="eventNameAr" value="<?= $event['title'] ?>" placeholder="event name">
                            </div>
                            <div class="form-group mt-2">
                                <label for="description">Description</label>
                                <textarea class="form-control" name="description" id="description" row="6" placeholder="description"><?= $event['title'] ?></textarea>
                            </div>
                            <div class="form-group mt-2">
                                <label for="descriptionAr">وصف الفعالية</label>
                                <textarea class="form-control" name="description_ar" id="descriptionAr" row="6" placeholder="description"><?= $event['title'] ?></textarea>
                            </div>
                            <div class="form-group mt-2">
                                <div class="row">
                                    <div class="col-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="aa-kpi-row d-flex mb-2">
                                <input type="text" class="form-control" name="kpi_val[0]" id="kpiVal0" style="margin-right: .3rem;" disabled>
                                <input type="text" class="form-control" name="kpi_val[0]" id="kpiVal0" style="margin-left: .3rem;" disabled>
