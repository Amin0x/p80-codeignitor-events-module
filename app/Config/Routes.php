...
$routes->get('events/(:num)/kpi/(:num)', 'Events::listKPIValueUpdates/$1/$2');
//$routes->get('events/(:num)/kpi/(:num)', 'Events::addOptionToEventAjax');
$routes->post('events/(:num)/kpi', 'Events::createKPI/$1');
$routes->post('events/(:num)/kpi/(:num)/delete', 'Events::deleteKPI/$1/$2'); //delete kpi
$routes->post('events/(:num)/kpi/(:num)/update', 'Events::updateKPI/$1/$2'); //update event-kpi value
